...
#ifdef OPENMP_GPU
!$omp target teams distribute parallel do map(tofrom:x3,y2,y3,z2,z3,u2,u3,w2,w3,mu,w0,w5,pif0)&
!$omp map(to:dbdr,dbdth,grcgt,bfld,radius,dydr,qhat,gr,gxdgy,curvbz,bdcrvb,grdgt,f,jfn,psip,psi,t0s,capts,xn0s,phincp,vparsp,psip2,dipdr,tor,mims,u2,q,br0,mu,iflr) &
!$omp shared (nthreads,i_beg,i_end,mm,ns,x2,lx,lr0,z2,delz,thfnz,rin,dr) &
!$omp shared (pi,dth,ntheta,dbdr,dbdth,grcgt,bfld,radius,dydr,qhat,gr,gxdgy) &
!$omp shared (curvbz,bdcrvb,grdgt,f,jfn,psip,psi,t0s,capts,capns,xn0s,phincp,vparsp) &
!$omp shared (psip2,dipdr,tor,mims,u2,q,br0,mu,iflr,q0,pi2,lr,y2,ly,dx,dy,dz) &
#ifdef COUPLING
!$omp shared (rhomax) &
#endif
!$omp shared (gclr,kcnt,ex,ey,ez,dpdz,dadz,apar,vexbsw,nonlin,delbx,delby,vparsw,iorb,r0,w2,ildu) &
!$omp shared (tgis,dt,w0,lz,nr,sf,iperidf,pif0,w5,peritr,x3,y3,z3,u3,w3) &
!$omp private (r,k,wz0,wz1,th,m,i,j,wx0,wx1,dbdrp,dbdtp,grcgtp,bfldp,radiusp) &
!$omp private (dydrp,qhatp,grp,gxdgyp,curvbzp,bdcrvbp,grdgtp,fp,jfnp,psipp,psp) &
!$omp private (ter,kaptp,kapnp,xnp,vncp,vparspp,psip2p,dipdrp,b,pzp,rhog,rhox,rhoy,phip) &
!$omp private (exp1,eyp,ezp,delbxp,delbyp,dpdzp,dadzp,aparp,alpha,l,xs,yt,xt,wk1,wk0,wi1,wi0,wj1,wj0) &
!$omp private (vfac,vp0,vpar,bstar,enerb,kap,dum1,vxdum,xdot,ydot,zdot,pzd0,pzdot,edot) &
!$omp private (dum,laps,qr,new_f0,w4,dw)
do ith=1,nthreads
...
#ifdef OPENMP_GPU
!$omp target teams distribute parallel do map(tofrom:u2,x2,y2,z2,w2,u3,x3,y3,z3,w3,w5,w0,mu,pif0,mypfl_es,mypfl_em,myefl_es,myefl_em,myke,mynos,myavewi) &
!$omp map(to:lr0,lx,delz,thfnz,rin,dr,pi,dth,dbdr,dbdth,grcgt,bfld,radius,dydr,qhat,gr,gxdgy,curvbz,bdcrvb,grdgt,f,jfn,psip,capts,capns,tor,psip2,dipdr,mims,phincp,vparsp,iflr,ex,ey,ez,delbx,delby,dpdz,dadz,apar) &
!$omp shared (mm,ns,x3,lx,lr0,z3,delz,thfnz,rin,dr,pi,dth,ntheta) &
!$omp shared (dbdr,dbdth,grcgt,bfld,radius,dydr,qhat,gr,gxdgy,curvbz,bdcrvb,grdgt) &
!$omp shared (f,jfn,psip,psi,t0s,capts,capns,xn0s,tor,psip2,dipdr,mims,u3,q,br0,phincp,vparsp,mu,iflr) &
#ifdef COUPLING
!$omp shared (rhomax) &
#endif 
!$omp shared (q0,pi2,lr,x2,y2,ly,dx,dy,dz,gclr,kcnt,ex,ey,ez,delbx,delby,dpdz,dadz,apar) &
!$omp shared (vexbsw,nonlin,vparsw,iorb,r0,y3,z2,u2,dt,w3,w0,w2) &
!$omp shared (lz,peritr,nr,sf,iperidf,nsubd,mypfl_es,mypfl_em,myefl_es,myefl_em,myke,mynos,myavewi,w5,pif0) &
!$omp private (r,k,wz0,wz1,i,wx0,wx1,th,dbdrp,dbdtp,grcgtp,bfldp,radiusp,dydrp,qhatp,grp,gxdgyp,curvbzp,bdcrvbp,grdgtp) &
!$omp private (fp,jfnp,psipp,psp,ter,kaptp,kapnp,xnp,b,psip2p,dipdrp,pzp,vncp,vparspp,rhog) &
!$omp private (rhox,rhoy,phip,exp1,eyp,ezp,delbxp,delbyp,dpdzp,dadzp,aparp,alpha) &
!$omp private (xs,l,yt,xt,j,wk1,wk0,wi1,wi0,wj1,wj0) &
!$omp private (vfac,vp0,vpar,bstar,enerb,kap,dum1,vxdum,xdot,ydot,zdot,pzd0,pzdot,edot,dum,w3old) &
!$omp private (laps,qr,new_f0,w4,dw)
#endif
...
#ifdef OPENMP_GPU     
!$omp target teams distribute parallel do map(tofrom:x3,y3,z3,u3,w3,mu,myden) &
!$omp map(to:lr0,lx,delz,thfnz,rin,dr,pi,dth,dbdr,dbdth,grcgt,bfld,radius,dydr,qhat,gr,gxdgy,f,jfn,psip,tor,mims,q,iflr,ly) &
!$omp shared (mm,ns,lr,dx,dy,dz,x3,lx,lr0,z3,delz,thfnz,ntheta,rin,dr,pi,dth,dbdr,dbdth,grcgt,bfld,radius,dydr,qhat,gr,gxdgy,f,jfn,psip,tor,mu,mims,q,iflr) &
#ifdef COUPLING
!$omp shared (rhomax,a,cce_in_weight,cce_out_weight,cce_side) &
#endif
!$omp shared (q0,u3,w3,pi2,y3,frac_inner,ly,gclr,kcnt,myden) &
#ifndef GYRO_TEST
!$omp shared (myjpar,mydti) &
#else
!$omp private (wi1,wi0,wj1,wj0,wk1,wk0) &
#endif
!$omp private (dv,r,k,wz0,wz1,th,i,wx0,wx1,dbdrp,dbdtp,grcgtp,bfldp,radiusp,dydrp,qhatp,grp,gxdgyp,fp,jfnp,psipp,b,rhog) &
!$omp private (rhox,rhoy,vfac,wght,vpar,alpha,l,xs,yt,xt,j) &
!$omp reduction(+:myden)
#endif     
